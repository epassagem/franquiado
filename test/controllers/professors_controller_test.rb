...
class ProfessorsControllerTest < ActionController::TestCase
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post :create, professor: { arquivo: @professor.arquivo, data_fim: @professor.data_fim, interessado_id: @professor.interessado_id, verificador: @professor.verificador }
    end
  ...
  test "should update professor" do
    patch :update, id: @professor, professor: { arquivo: @professor.arquivo, data_fim: @professor.data_fim, interessado_id: @professor.interessado_id, verificador: @professor.verificador }
    assert_redirected_to professor_path(assigns(:professor))
  end
