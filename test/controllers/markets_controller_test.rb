...
class MarketsControllerTest < ActionController::TestCase
  ...
  test "should create market" do
    assert_difference('Market.count') do
      post :create, market: { arquivo: @market.arquivo, interessado_id: @market.interessado_id, nome: @market.nome }
    end
  ...
  test "should update market" do
    patch :update, id: @market, market: { arquivo: @market.arquivo, interessado_id: @market.interessado_id, nome: @market.nome }
    assert_redirected_to market_path(assigns(:market))
  end
